...
**Status:** Day 3 complete (2026-09-13). Chat models, form, view, and template all verified end-to-end against real Postgres (a real `chat_conversation` row for `gurudev`, two real `chat_message` rows — user + echoed assistant reply — in correct chronological order). Day 4 (HTMX wiring) not started.
