...
**Status:** Day 2 complete (2026-09-10). Register/login/logout/home all verified end-to-end against real Postgres (real rows: a superuser + two ordinary registered users, correctly differentiated by is_staff/is_superuser). Day 3 (chat models & static shell) not started.
